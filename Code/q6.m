...
C = eye(5);
Qr = diag([100,0,5000,0,0]); %Weight Matrix for x
%Bryson rule
...
title1 = sprintf('State response ($q_{r1}=%g$, $q_{r2}=%g$, $q_{r3}=%g$, $q_{r4}=%g$, $q_{r5}=%g$, $R_r=%g$)', Qr(1,1), Qr(2,2), ...
    Qr(3,3), Qr(4,4), Qr(5,5), Rr);
...
title2 = sprintf(['LQR Control Effort: Motor Voltage [V] ($q_{r1}=%g$, $q_{r2}=%g$, $q_{r3}=%g$, ' ...
    '$q_{r4}=%g$, $q_{r5}=%g$ ,$R_r=%g$)'], Qr(1,1), Qr(2,2), Qr(3,3),Qr(4,4),Qr(5,5), Rr);
